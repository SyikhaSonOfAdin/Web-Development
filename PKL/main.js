...
const ActiveTrackPage = function () {
    document.getElementById('HomePage').style.display = 'none';
    document.getElementById('burger').style.display = 'none';
    document.getElementsByClassName('back-arrow1')[0].style.display = 'block';
    document.getElementById('TrackPage').style.display = 'flex';
    document.getElementById('navbar').style.margin = '0px'
};
const PrevTrackPage = function () {
    document.getElementById('HomePage').style.display = 'block'
    document.getElementById('burger').style.display = 'block'
    document.getElementsByClassName('back-arrow1')[0].style.display = 'none'
    document.getElementsByClassName('Pages')[0].style.display = 'none'
    document.getElementById('navbar').style.margin = '0 0 30px 0'
}
const Page1 = document.getElementById('TrackPage');
if (Page1.innerHTML == "") {
    const Peringatan = '<div id="warn-cont">' +
        ...
        '</h1>' +
        '</div>';
    Page1.insertAdjacentHTML('afterbegin', Peringatan);
}
